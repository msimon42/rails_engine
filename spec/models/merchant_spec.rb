...
RSpec.describe Merchant, type: :model do
  ...
  describe 'methods' do
    ...
    it 'revenue_by_date' do
      ...
      create :transaction, invoice: invoice_1, created_at: Time.new
      create :transaction, invoice: invoice_2, created_at: Time.new
      create :transaction, invoice: invoice_3, created_at: Time.new
      create :transaction, invoice: invoice_4, created_at: Time.new
      create :transaction, invoice: invoice_5, created_at: Time.parse('2019-12-14')
      create :transaction, invoice: invoice_6, created_at: Time.parse('2019-12-15')

      expect(Merchant.revenue_by_date(Time.new.to_s).length).to eq(4)
